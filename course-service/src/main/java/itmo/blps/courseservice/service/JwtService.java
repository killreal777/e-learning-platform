...
import itmo.blps.courseservice.CourseServiceConfig;
...
public class JwtService {
    ...
    public String generateToken(User user) {
        ...
        return buildToken(extraClaims, user, courseServiceConfig.security().jwt().expiration());
    }
    ...
    private Key getSignInKey() {
        return Keys.hmacShaKeyFor(Decoders.BASE64.decode(courseServiceConfig.security().jwt().secretKey()));
    }
}